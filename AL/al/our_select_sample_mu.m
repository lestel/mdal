function [choose_serials_this_time,rank,diff]=our_select_sample_mu(tr,tr_label,now_part_train_sample_ind,rest_part_train_sample_ind,options,options_active,ORorCL,view_num,al_array)
method=7;
...
[~,rank2,diff2]=diveristy_select_sample_new2(tr,tr_label,now_part_train_sample_ind,rest_part_train_sample_ind(pos1),options,options_active,ORorCL,view_num,al_array);
