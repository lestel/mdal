function result_show(all_result,label_cost,AL_th,smooth_th,CLorOR)
name={'Random','Multiple-view','Ted','Maed','Diveristy','Uncertainty','Our method','f1 method','f2 method'};
color={[0,0,0],...      %ºÚ
       [255,255,0]/255,...%»Æ
       [255,0,255]/255,...%·Û
       [0,0,255]/255,...%À¶
